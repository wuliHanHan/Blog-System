...
<body>
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li><a href="javascript:void(0)"><i
						class="fa fa fa-qrcode"></i> <span class="nav-label">文章管理</span>
				...
				<li class="active"><a href="javascript:void(0)"><i class="fa fa fa-qrcode"></i>
							...
							<div class="ibox-content">
								<div class="row">
									...
									<button type="button" class="btn btn-sm btn-danger"
										onclick="addManager()">新增用户</button>
								</div>

								<!-- 表格数据 -->
								<div id="dataList">
									<c:if test="/admin/list"></c:if>
								</div>
							</div>
						</div>
					</div>
	...
	<!-- 编辑页面 -->
	<div class="modal inmodal" id="editManagerModal" tabindex="-1"
		role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div id="editManagerContent" class="modal-body"></div>
		</div>
	</div>


	<!-- 新增页面 -->
	<div class="modal inmodal" id="addManagerModal" tabindex="-1"
		role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div id="addManagerContent" class="modal-body"></div>
		</div>
	</div>
	...
	<script src="<%=basePath%>js/admin/admin.js"></script>
